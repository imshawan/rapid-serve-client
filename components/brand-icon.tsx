...
export function BrandIcon({className, withIcon=true, iconClassname, textClassname}: Partial<BrandIconProps>) {
  return (
    <Fragment>
      {withIcon ? <div className={className}>
        <svg version="1.0" xmlns="http://www.w3.org/2000/svg"
          width="512.000000pt" height="260.000000pt" viewBox="0 0 512.000000 260.000000" className={cn(
            "h-8 w-8 fill-black dark:fill-white",
            iconClassname
          )}
      ...
      <div className={cn(
        "text-xl font-bold m-auto",
        textClassname
      )}>Rapid<span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-blue-400">Serve</span></div>
    </Fragment>
  )
}