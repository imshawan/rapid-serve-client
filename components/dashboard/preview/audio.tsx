...
export default function Audio({ file, data, mimeType, outerClassname, className, onShare }: AudioProps) {
  ...
  return (
    <div className={cn("w-full h-full flex flex-col bg-gray-50 dark:bg-gray-900", outerClassname)}>
      {/* Top Bar */}
      <div className="w-full px-4 sm:px-6 py-3 sm:py-4 bg-white dark:bg-gray-800 flex items-center justify-between">
        ...
        <div className="flex items-center space-x-2 sm:space-x-3">
          ...
          <button
            className="p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-700 transition"
            title="Share"
            onClick={() => onShare && onShare(file?.fileName, file?.fileId)}
          >
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-4 px-0 sm:py-12">
        ...
        {/* Controls */}
        <div className="w-full sm:max-w-2xl p-4 sm:p-0">
          <div className="w-full flex flex-col sm:flex-row items-center justify-center sm:justify-between bg-white dark:bg-gray-800 rounded-2xl p-4 shadow-lg space-y-4 sm:space-y-0">
